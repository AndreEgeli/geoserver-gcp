...
mkdir -p "${MNT_DIR}"
gcsfuse -o rw,allow_other -file-mode=777 -dir-mode=777 --implicit-dirs --debug_gcs --debug_fuse $BUCKET $MNT_DIR 
...
# sed -i "s#GEOSERVER_DATA_DIR.*#GEOSERVER_DATA_DIR=${GEOSERVER_DATA_DIR}#" /usr/local/tomcat/webapps/geoserver/WEB-INF/web.xml
